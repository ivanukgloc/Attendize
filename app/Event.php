...
class Event extends MyBaseModel
{
    ...
    {
        return $this->belongsToMany(\App\Question::class, 'event_question');
    }
    ...
    {
        return $this->belongsToMany(\App\Question::class, 'event_question')->withTrashed();
    }
    ...
    {
        return $this->hasMany(\App\Attendee::class);
    }
    ...
    {
        return $this->hasMany(\App\EventImage::class);
    }
    ...
    {
        return $this->hasMany(\App\Message::class)->orderBy('created_at', 'DESC');
    }
    ...
    {
        return $this->hasMany(\App\EventStats::class);
    }
    ...
    {
        return $this->hasMany(\App\Affiliate::class);
    }
    ...
    {
        return $this->belongsTo(\App\Organiser::class);
    }
