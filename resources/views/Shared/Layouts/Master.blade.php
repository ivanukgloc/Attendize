        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown profile">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a target="_blank" href="http://app.heartlandticket.com/feedback.php?v={{ config('attendize.version') }}"><span class="icon ico-megaphone"></span>@lang("Top.feedback_bug_report")</a></li>
                    <li class="divider"></li>
