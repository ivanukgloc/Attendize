    ...
    <meta name="apple-mobile-web-app-title" content="EventCheckout">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ asset("assets/images/touch/favicon-196x196.png") }}">
    <link rel="icon" type="image/png" sizes="128x128" href="{{ asset("assets/images/touch/favicon-128.png") }}">
    ...
    <meta name="application-name" content="EventCheckout">
